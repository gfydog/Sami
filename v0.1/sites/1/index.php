            ...
            <div class="row s-header__inner width-sixteen-col">
                ...
                <div class="s-header__block">
                    <div class="s-header__logo">
                        <a class="logo" href="index.html">
                            <div style="border-radius: 5px; width: 100px; height: 40px; background-image: url('<?= $data['nav']['logo'] ?>'); background-position: center; background-size: cover;">
                            </div>
                        </a>
                    </div>
                ...
                <nav class="s-header__nav">
                    ...
                    <div class="s-header__contact">
                        <a href="<?= $data['nav']['mainBtnUrl'] ?>" class="btn btn--primary s-header__contact-btn"><?= $data['nav']['mainBtnText'] ?></a>
                ...
                <div class="row s-intro__content width-sixteen-col">
                    ...
                    <div class="column lg-12 s-intro__content-inner grid-block">
                        ...
                        <div class="s-intro__content-text">
                            <div class="s-intro__content-pretitle text-pretitle"><?= $data['welcome'] ?></div>
                ...
                <div class="row s-about__content width-sixteen-col">
                    <div class="column grid-block grid-section-split">
                        ...
                        <div class="s-about__content-btn grid-section-split__bottom">
                            <a href="<?= $data['aboutMe']['button']['url'] ?>" class="btn btn--stroke u-fullwidth"><?= $data['aboutMe']['button']['text'] ?></a>

                            <ul class="s-about__social social-list">
                                <?php if (isset($data['socialLinks']['facebook']['url']) && !empty($data['socialLinks']['facebook']['url'])) { ?>
                                    <li>
                                        <a href="<?= $data['socialLinks']['facebook']['url'] ?>">
                                ...
                                <?php } ?>
                                <?php if (isset($data['socialLinks']['twitter']['url']) && !empty($data['socialLinks']['twitter']['url'])) { ?>
                                <li>
                                    <a href="<?= $data['socialLinks']['twitter']['url'] ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                                ...
                                <?php } ?>
                                <?php if (isset($data['socialLinks']['instagram']['url']) && !empty($data['socialLinks']['instagram']['url'])) { ?>
                                <li>
                                    <a href="<?= $data['socialLinks']['instagram']['url'] ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                                ...
                                <?php } ?>
                                <?php if (isset($data['socialLinks']['web']['url']) && !empty($data['socialLinks']['web']['url'])) { ?>
                                <li>
                                    <a href="<?= $data['socialLinks']['web']['url'] ?>">
                                        ...
                                        <span class="u-screen-reader-text">Website</span>
                                    </a>
                                </li>
                                <?php } ?>
                ...
                <div class="row s-expertise__content width-sixteen-col">
                    <div class="column xl-12 grid-block grid-section-split">
                        ...
                        <div class="section-header grid-section-split__header">
                            ...
                            <h2 class="text-display-title">
                                <?= $data['keyAreas']['slogan'] ?>
                            </h2>

                            <p class="lead">
                                <?= $data['keyAreas']['summary'] ?>
                            </p>
                        </div> <!-- end section-header -->
                                ...
                                <?php foreach ($data['keyAreas']['details'] as $detail) { ?>
                                    <div class="grid-list-items__item list-items__item">
                                        <div class="grid-list-items__title list-items__item-header">
                                            <h3 class="list-items__item-title"><?= $detail['title'] ?></h3>
                                        </div>
                        ...
                        <div class="s-expertise__content-btn grid-section-split__bottom">
                            <a href="<?= $data['keyAreas']['btnUrl'] ?>" class="btn btn--stroke u-fullwidth"><?= $data['keyAreas']['btnText'] ?></a>
                        </div> <!-- end s-about__content-btn -->
                    ...
                    <div class="column xl-12 testimonials">
                        ...
                        <div class="swiper-container testimonials__slider home-slider">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php for ($i = 0; $i < count($data['clients']['reviews']); $i++) { ?>
                                    <div class="testimonials__slide swiper-slide">
                                        <p>
                                            <?= $data['clients']['reviews'][$i]['textReview'] ?>
                                        </p>
                                        <div class="testimonials__author">
                                            <cite class="testimonials__cite">
                                                <strong><?= $data['clients']['reviews'][$i]['name'] ?></strong>
                                                <span><?= $data['clients']['reviews'][$i]['position'] ?></span>
                                            </cite>
                                        </div>
                                    </div>
                                <?php } ?>
            ...
            <div class="row row-x-center text-center">
                <div class="column xl-8 lg-12">
                    ...
                    <div class="s-cta__content">
                        <h2 class="text-display-title">
                            <?= $data['callToAction']['slogan'] ?>
                        </h2>
                        <p class="lead">
                            <?= $data['callToAction']['details'] ?>
                        </p>
                        <a href="<?= $data['callToAction']['buttonUrl'] ?>" class="btn btn--primary"><?= $data['callToAction']['buttonText'] ?></a>
                    </div>
            ...
            <div class="row s-journal__content width-sixteen-col">
                <div class="column xl-12 grid-block">
                    ...
                    <div class="grid-full s-journal__content-main grid-list-items">
                        ...
                        <?php for ($i = 0; $i < count($data['news']['articles']); $i++) { ?>

                            <div class="grid-list-items__item blog-card">
                                <div class="blog-card__header">
                                    <div class="blog-card__cat-links">
                                        <a href="<?= $data['news']['articles'][$i]['url'] ?>"><?= $data['news']['articles'][$i]['type'] ?></a>
                                    </div>
                                    <h3 class="blog-card__title"><a href="<?= $data['news']['articles'][$i]['url'] ?>"><?= $data['news']['articles'][$i]['title'] ?></a></h3>
                                </div>
                                <div class="blog-card__text">
                                    <p>
                                        <?= (isset($data['news']['articles'][$i]['summary']))?$data['news']['articles'][$i]['summary']:"" ?>
                                    </p>
                                </div>
                            </div> <!-- end blog-card -->
        ...
        <footer class="s-footer">
            <div class="row s-footer__content">
                <div class="column xl-9 lg-6 md-12 s-footer__block s-footer__about">
                    ...
                    <p>
                        <?= $data['footer']['finalDescription'] ?>
                    </p>
                </div>
                <div class="column xl-3 lg-6 md-12 s-footer__block s-footer__site-links">
                    <h3><?= $data['footer']['titleLinks'] ?></h3>
                    <ul class="link-list">
                        <?php for ($i = 0; $i < count($data['footer']['links']); $i++) { ?>
                            <li><a href="<?= $data['footer']['links'][$i]['url'] ?>"><?= $data['footer']['links'][$i]['text'] ?></a></li>
                        <?php } ?>
            ...
            <div class="row s-footer__bottom">
                <div class="column xl-6 lg-12">
                    ...
                    <?php if (isset($data['socialLinks']['facebook']['url']) && !empty($data['socialLinks']['facebook']['url'])) { ?>
                        ...
                        <?php } ?>
                        <?php if (isset($data['socialLinks']['instagram']['url']) && !empty($data['instagram']['web']['url'])) { ?>
                        <li>
                            <a href="<?= $data['socialLinks']['instagram']['url'] ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                                    <path d="M11.999,7.377c-2.554,0-4.623,2.07-4.623,4.623c0,2.554,2.069,4.624,4.623,4.624c2.552,0,4.623-2.07,4.623-4.624 C16.622,9.447,14.551,7.377,11.999,7.377L11.999,7.377z M11.999,15.004c-1.659,0-3.004-1.345-3.004-3.003 c0-1.659,1.345-3.003,3.004-3.003s3.002,1.344,3.002,3.003C15.001,13.659,13.658,15.004,11.999,15.004L11.999,15.004z"></path>
                ...
                <div class="column xl-6 lg-12">
                    <p class="ss-copyright">
                        <span>© Copyright Goofy Technology Group <?= date('Y') ?></span><br>
