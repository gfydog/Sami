    ...
    <div id="page" class="s-pagewrap">
            ...
            <div class="row s-header__inner">
                ...
                <nav class="s-header__nav">
                    ...
                    <ul class="s-header__menu-links">
                        ...
                        <li><a href="#services" class="smoothscroll">Info</a></li>
                        <li><a href="#folio" class="smoothscroll">Clients</a></li>
        ...
        <section id="content" class="s-content">
            ...
            <section id="intro" class="s-intro target-section">
                ...
                <div class="s-intro__bg" style="background-image: url(<?= $data['nav']['logo'] ?>);"></div>
                ...
                <div class="row s-intro__content">
                    ...
                    <div class="column lg-12 s-intro__content-inner">
                        ...
                        <div class="s-intro__content-buttons">
                            <a href="<?= $data['nav']['mainBtnUrl'] ?>" class="btn btn--stroke s-intro__content-btn"><?= $data['nav']['mainBtnText'] ?></a>
                        </div>
            ...
            <section id="about" class="s-about target-section">
                ...
                <div class="row list-block block-lg-one block-tab-whole block-stack-on-1000 s-footer__btns">
                    <div class="column list-block__item">
                        <div class="s-footer__contact-btn">
                            <a href="<?= $data['callToAction']['buttonUrl'] ?>" class="btn btn--primary u-fullwidth">
        ...
        <footer id="footer" class="s-footer target-section">
            ...
            <div class="row section-header" data-num="04">
                ...
                <div class="column lg-6 stack-on-1100 section-header__primary">
                    <h2 class="title text-display-1">
                        <?= $data['callToAction']['slogan'] ?> <a href="<?= $data['callToAction']['buttonUrl'] ?>" title=""><?= $data['callToAction']['buttonText'] ?></a>
                    </h2>
                </div>
                <div class="column lg-6 stack-on-1100 section-header__secondary">
